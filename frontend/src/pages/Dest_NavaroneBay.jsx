...
const fetchImage = async () => {
  ...
  const destImages = Object.values(
    parametersPicDestination.PicDestinations.Destination_4
  );
  return destImages;
};

const Dest_NavaroneBay = () => {
  const { title, intro, paragraph1, paragraph2, to1, to2, back, forward } =
    parametersDestination.destinations.navarone_bay;
...
export default Dest_NavaroneBay;
