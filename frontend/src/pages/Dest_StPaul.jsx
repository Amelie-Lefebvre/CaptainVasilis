...
const fetchImage = async () => {
  ...
  const destImages = Object.values(
    parametersPicDestination.PicDestinations.Destination_2
  );
  return destImages;
};

const Dest_ParadiseRock = () => {
  const { title, intro, paragraph1, paragraph2, to1, to2, back, forward } =
    parametersDestination.destinations.saint_pauls_bay;
  return (
    <>
...
export default Dest_ParadiseRock;
