...
const fetchImage = async () => {
  ...
  const destImages = Object.values(
    parametersPicDestination.PicDestinations.Destination_5
  );
  return destImages;
};

const Dest_RedSandBeach = () => {
  const { title, intro, paragraph1, paragraph2, to1, to2, back, forward } =
    parametersDestination.destinations.red_sand_beach;
...
export default Dest_RedSandBeach;
